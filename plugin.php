...
for(i=0; i<p4g_dt.length; i++)
{
  ...
  p4g_dt[i].innerHTML += \'<br /><a href="http://pinterest.com/pin/create/button/?url=\' + location . href + \'&media=\' + p4g_a[0].href + \'" class="pin-it-button" count-layout="horizontal">Pin It</a>\';
}
